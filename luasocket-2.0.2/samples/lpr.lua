...
local function usage()
  ...
  print(
     ...
     '  queue_obj.lua=remote queue_obj.lua or printer name (default "printer")\n' ..
...
-- trivial tests
--lua lp.lua lp.lua queue_obj.lua=default host=localhost
--lua lp.lua lp.lua queue_obj.lua=default host=localhost format=binary localbind=1
--lua lp.lua query queue_obj.lua=default host=localhost
